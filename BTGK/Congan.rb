...
class Xemay < Phuongtien
    attr_accessor :congsuat134, :dungtichbs134
    def initialize(id134,hangsanxuat134,namsanxuat134,dongxe134,giaban134,bienso134,mauxe134,congsuat134,dungtichbs134)
        super(id134,hangsanxuat134,namsanxuat134,dongxe134,giaban134,bienso134,mauxe134)
        @congsuat134 = congsuat134
        @dungtichbs134 = dungtichbs134
    end
    def hienthi
        ...
        chon134 = gets.chomp
            if chon134 == "1" then
                ...
                $a.push(Oto.new(id134,hsx,nsm134,gx,gb134,bs134,mx,scn134,kdc134,nl134,stk134,ndk134))
                    ...
                    dtbs134 = gets.chomp
                    $a.push(Xemay.new(id134,hsx,nsm134,gx,gb134,bs134,mx,dt134,dtbs134))
                elsif chon134 =="3" then
                    puts "Nhập trọng tải"
                    tt134 = gets.chomp
                    $a.push(Xetai.new(id134,hsx,nsm134,gx,gb134,bs134,mx,tt134))
                end                          
    end
    def xoa(id)
        $a.each_index{
